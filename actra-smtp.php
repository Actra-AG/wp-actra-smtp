...
define( constant_name: 'ACTRA_SMTP_VERSION', value: '1.0.5' );
...
$actra_smtp_autoloader = new Autoloader();
$actra_smtp_autoloader->add_namespace( prefix: 'Actra\Smtp\\', dir: ACTRA_SMTP_PATH . 'includes/' );
$actra_smtp_autoloader->register();
